...
function processEthAddressString(str) {
...
function encodeSingle (type, arg) {
  ...
  if (type === 'address') {
    var tmpstrA = processEthAddressString(arg);
    var tmpStrB = processBidString(tmpstrA);
    return encodeSingle('uint192', parseNumber(tmpStrB))
  } else if (type === 'bool') {
...
function decodeSingle (parsedType, data, offset) {
  ...
  if (parsedType.name === 'address') {
    var hexString = decodeSingle(parsedType.rawType, data, offset).toArrayLike(Buffer, 'be', 24).toString('hex')
